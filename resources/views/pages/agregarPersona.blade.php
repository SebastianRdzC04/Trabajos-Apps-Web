                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{ route('updatePersona') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="personas-edit" id="personas-edit" class="form-select"
                                                onchange="fetchPersonaData()">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="apellido-edit"
                                                name="apellido-edit" required>
                                            @if ($errors->has('apellido'))
                                                <div class="alert alert-danger">{{ $errors->first('apellido') }}</div>
                                            @endif
                                        </div>
                                        <div class="mb-3">
                                            <label for="fecha_nacimiento-edit" class="form-label">Fecha de
                                                Nacimiento</label>
                                            <input type="date" class="form-control" id="fecha_nacimiento-edit"
                                                name="fecha_nacimiento-edit" required>
                                            @if ($errors->has('fecha_nacimiento'))
                                                <div class="alert alert-danger">{{ $errors->first('fecha_nacimiento') }}
                                                </div>
                                            @endif
                    ...
                    <div class="col-md-12">
                        <div class="card mt-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="">
                                    {{ $Ppersonas->links('pagination::bootstrap-5') }}
                                </div>
                            </div>
                        </div>
                    </div>
